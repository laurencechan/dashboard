...
class ResourceTracker(object):
    ...
    def update_available_resource(self, context):
        ...
        if "cpu_info" not in resources or resources["cpu_info"] is None:
            resources["cpu_info"] = ''
        if "compute_info" not in resources or resources["compute_info"] is None:
            resources["compute_info"]=''
    ...
    def _update_usage_from_orphans(self, orphans):
        ...
        for orphan in orphans:
            ...
            self._update_usage(usage)
    #modify by xieweijie on 2017-06-15
    #NOTE:add the 'compute_info' into 'resource_keys'
    def _verify_resources(self, resources):
        resource_keys = ["vcpus", "memory_mb", "local_gb", "cpu_info",
                         "vcpus_used", "memory_mb_used", "local_gb_used",
                         "numa_topology","compute_info"]
