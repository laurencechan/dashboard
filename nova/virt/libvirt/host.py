...
#for list_net_devices
#return:a list of virNodeDevice instance
    def list_net_devices(self,flags=0):
	return self.get_connection().listDevices("net",flags)
#for list_system_devices
#return:a list of virNodeDevice instance
    def list_system_devices(self,flags=0):
	return self.get_connection().listDevices("system",flags)
#end
