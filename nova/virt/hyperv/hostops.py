...
class HostOps(object):
    ...
    def _get_cpu_info(self):
        ...
        return cpu_info
#add by xieweijie on 2017-06-14
#for get_comopute_info
    def _get_compute_info(self):
        compute_info=dict()
        processors=self._hostutils.get_cpu_extra_info()
        compute_info['corehz']=processors[0]['MaxClockSpeed']
        compute_info['Description']=processors[0]['OtherFamilyDescription']
        compute_info['netcardnums']=self._hostutils.get_netcard_info()
        pc_info = self._hostutils.get_computer_info
        compute_info['Manufacturer']=pc_info[0]['Manufacturer']
        compute_info['Product']=pc_info[0]['Product']
        return compute_info
    ...
    def get_available_resource(self):
        ...
        #for compute info
        compute_info = self._get_compute_info()
        #end
        dic = {'vcpus': vcpus,
               ...
               'numa_topology': None,
               'compute_info':jsonutils.dumps(compute_info)
               }
