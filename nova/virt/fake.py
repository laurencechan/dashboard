...
class FakeDriver(driver.ComputeDriver):
    ...
    def __init__(self, virtapi, read_only=False):
        ...
        self.host_status_base = {
          ...
          'cpu_info': {},
        #modify by xieweijie on 2017-06-14
          'compute_info':{},
        #end
    ...
    def get_available_resource(self, nodename):
        ...
        #modify by xieweijie on 2017-0-14
        compute_info = collections.OrderedDict([
            ('manufacturer','DELL'),
            ('model','PowerEdge R910'),
            ('cpu_type','Intel(R) Xeon(R) CPU E7- 4830 @ 2.13GHz'),
            ('netcards','4')
            ('core_hz','2127Mhz'),
        ])
        #end
        ...
        #add by xieweijie on 2017-06-17
        host_status['compute_info'] = jsonutils.dumps(compute_info)
        #end
        return host_status
