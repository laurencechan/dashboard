...
class ComputeNode(base.NovaPersistentObject, base.NovaObject):
    ...
    fields = {
        ...
        #add for compute info
        'compute_info':fields.StringField(nullable=True),
        #end
        }
